...
import com.example.chating.Adapter.MycollectcomAdapter;
...
public class Fragment_comunity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate( R.layout.fragmen_comunity,container,false );
    }
                ...
                if(e==null)
                {
                    if(list.size()>0)
                    {
                      swipe_com.setVisibility( View.VISIBLE );
                        data=list;
                       mycollectcomAdapter=new MycollectcomAdapter(data,getActivity());
