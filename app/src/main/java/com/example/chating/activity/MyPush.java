...
import com.example.chating.Adapter.MyPushAdapter;
...
public class MyPush extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Bmob.initialize(MyPush.this,"cd473015f750ae3623c318c168e31d57");
    ...
    SwipeMenuItemClickListener swipeMenuItemClickListener=new SwipeMenuItemClickListener(){
        ...
        public void onItemClick(SwipeMenuBridge menuBridge) {
          ...
          final   int adapterPosition=menuBridge.getAdapterPosition();//recyclerView的Item的positon
            ...
            if(direction==SwipeMenuRecyclerView.RIGHT_DIRECTION)//右边
            {
                Post post=new Post();
