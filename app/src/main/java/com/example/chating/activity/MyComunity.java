...
import com.example.chating.Adapter.MyComunityAdapter;
...
public class MyComunity extends AppCompatActivity {
    ...
    List<Comunity> data;
    private  MyComunityAdapter myComunityAdaper;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Bmob.initialize(MyComunity.this,"cd473015f750ae3623c318c168e31d57");
        initView();
            ...
            public void done(List<Comunity> list, BmobException e) {
                ...
                if(e==null)
                {
                    ...
                    if(data.size()>0)
                    {
                        ...
                        myComunityAdaper = new MyComunityAdapter( MyComunity.this, data );
                        mycomrv.setLayoutManager( new LinearLayoutManager( MyComunity.this ) );
                        mycomrv.setAdapter(myComunityAdaper );
                    }
                    else
                    {
    ...
    SwipeMenuItemClickListener swipeMenuItemClickListener=new SwipeMenuItemClickListener(){
        ...
        public void onItemClick(SwipeMenuBridge menuBridge) {
            ...
            final   int adapterPosition=menuBridge.getAdapterPosition();//recyclerView的Item的positon
            int position=menuBridge.getPosition();//菜单在RecyclerView的Item中的Positon

            if(direction==SwipeMenuRecyclerView.RIGHT_DIRECTION)//左边
            {
                ...
                comunity.delete( new UpdateListener() {
                    ...
                    public void done(BmobException e) {
                        if(e==null)
                        {
                            ...
                            myComunityAdaper .notifyDataSetChanged();
